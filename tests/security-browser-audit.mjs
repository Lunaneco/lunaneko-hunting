...
try{
 ...
 if(!hosted){const dev='http://127.0.0.1:5174';const forbidden=['/.git/config','/audit/model-swap/nyanluna-export.json','/backups/security-base-20260921/README.md','/models/SOURCE_REFERENCE/nyanluna.blend','/docs/LOCAL-DEVELOPMENT-HISTORY.md'];
