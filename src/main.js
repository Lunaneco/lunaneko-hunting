...
$('#app').innerHTML=`
  <section id="home" class="home" aria-label="タイトル画面">
    ...
    <footer class="home-footer"><span>NYANLUNA <i>×</i> TSUKINEKO</span><button id="chapter-menu-open">メニュー・育成</button><button data-open="guide">操作ガイド ${icon('arrow')}</button><span class="version">LUNANEKO ADVENTURE / 1.38</span></footer>
  </section>
